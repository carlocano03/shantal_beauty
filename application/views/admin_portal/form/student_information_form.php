...
<table class="tbl_header">
    <tr>
        <td colspan="2" class="text-center text-uppercase bg-header">Scholarhip/Study Grant Information</td>
    </tr>
    <tr>
        <td class="fw-bold td-bg" style="width:11%;">School Name:</td>
        <td><?= isset($application['school_name']) ? ucwords($application['school_name']) : '';?></td>
    </tr>
</table>
<table class="tbl_header">
    <tr>
