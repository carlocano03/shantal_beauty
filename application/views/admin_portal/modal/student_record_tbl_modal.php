                ...
                <div class="row row-cols-1 gap-3">
                    <div class="col border-bottom pb-3">
                        <div class="row align-items-center">
                            ...
                            <div class="col modal__data">#12312312312</div>
                        </div>
                    </div>
                    <div class="col border-bottom pb-3">
                        <div class="row align-items-center">
                    ...
                    <div class="col border-bottom pb-3">
                        <div class="row align-items-center">
                            ...
                            <div class="col modal__data">jakecastor@gmail.com</div>
                        </div>
                    </div>
                    <div class="col border-bottom pb-3">
                        <div class="row align-items-center">
                            <div class="col modal__label">School:</div>
                            <div class="col modal__data">Nueva Ecija University of Science Technology</div>
                        </div>
                    </div>
                    <div class="col border-bottom pb-3">
                        <div class="row align-items-center">
                            <div class="col modal__label">Birthday:</div>
                            <div class="col modal__data">January 3, 1994</div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="row align-items-center">
                            <div class="col modal__label">Civil Status:</div>
                            <div class="col modal__data">Single</div>
                        </div>
                    </div>
                </div>
            </div>
