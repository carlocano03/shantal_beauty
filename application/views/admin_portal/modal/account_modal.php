<?php
    $user_type_id = $this->cipher->decrypt($this->input->get('info'));
?>
<!-- Modal -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php if($user_type_id == ADMINISTRATOR) : ?>
                    <div class="alert alert-danger"><i class="bi bi-info-circle-fill me-2"></i>Administrator Account</div>
                <?php else: ?>
