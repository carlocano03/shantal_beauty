    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            <div class="card-header mb-3 pb-3 d-flex align-items-center gap-2 ">
                <img src="<?php echo base_url('assets/images/home/profile-reseller.png'); ?>" width="36px"
                    alt="Calendar" />
                <h5 class="table__title"><?= $card_title?></h5>
            </div>
            <div class="card-body mt-4">
                <table class="table" width="100%" id="tbl_reseller_account">
                    <thead>
                        <tr>
                            <th>Reseller ID</th>
                            <th>Name</th>
...
<script>
    $(document).ready(function() {
        var tbl_reseller_account = $('#tbl_reseller_account').DataTable({
            language: {
                search: '',
