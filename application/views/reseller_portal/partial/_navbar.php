    ...
    <nav class="layout-navbar  navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme "
        ...
        <div class="container d-flex justify-content-end">
            ...
            <ul class="dropdown-menu dropdown-menu-end" style="position:absolute; z-index: 1050;">
                    ...
                    <a class="dropdown-item" href="#">
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1">
                                <span class="fw-semibold d-block"><?= $this->session->userdata('resellerIn')['fullname']?></span>
                                <small class="text-muted"><i><?= $this->session->userdata('resellerIn')['email_add']?></i></small>
                            </div>
                        </div>
                    </a>
                </li>
                ...
                <li>
                    <a class="dropdown-item" href="<?= base_url('reseller/main/logout/resellerIn');?>">
