<div class="offcanvas offcanvas-end" data-bs-backdrop="static" tabindex="-1" id="addressModal"
    aria-labelledby="offcanvasRightLabel">
    <div class="offcanvas-header border-bottom p-5">
        <h5 id="offcanvasRightLabel" class="cart__title">Address Selection</h5>
    ...
    <div class="offcanvas-body cart__container">
        <div class="cart__items p-4 py-0">
            ...
            <div class="collapse mt-2" id="collapseAddress">
