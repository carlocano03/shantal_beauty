    <div class="offcanvas offcanvas-end" data-bs-backdrop="static" tabindex="-1" id="offcanvasRight"
        ...
        <div class="offcanvas-header border-bottom p-5">
            <h5 id="offcanvasRightLabel" class="cart__title">Your Cart <span class="cart_count_list"
                    style="font-size:18px;"></span></h5>
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    ...
                    <p class="footer__p">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Odit, unde. Nobis
                        dolor
                        mollitia cum ad?
