...
<head>
    ...
    <title>Change Life Christian Church</title>
            ...
            <div class="container-xxl">
                <div class="row row-cols-1 row-cols-lg-2 hero-page__row gx-0 gx-lg-4 gy-5 gy-lg-0"
                    ...
                    <div class="col">
                        ...
                        <button class="hero-page_button animate__animated animate__fadeInUp">
                            Admission
                        </button>
                    </div>
                    <div class="col">
                ...
                <div class="card position-absolute overflow-hidden top-100 start-50 translate-middle inqueries"
                    ...
                    <div class="row">
                        ...
                        <div class="col py-2 pt-3 border bg-white text-black d-flex flex-column gap-2">
                            <div class="d-flex justify-content-center">
                                <i class="fa-solid fa-globe fs-5 fs-lg-2 text-title"></i>
                            </div>
                            <h5 class="text-center text-title inqueries__text">
                                Origami Site
                            </h5>
                    ...
                    <div class="col position-relative">
                        <div class="d-flex flex-column gap-2">
                            ...
                            <div class="d-flex flex-column position-absolute" style="right: -10px; top: 60px">
                                <button
                                    class="about-us_img-button about-us__history-btn about-us_img-button--active mt-2">
                                    History
                                </button>
        ...
        <section class="contact-us mt-lg-5 mt-2 bg-light">
            <div class="container-xxl py-5">
                <div class="row row-cols-1 row-cols-lg-2 gy-5 mt-5 gx-5 py-2">
                    ...
                    <div class="col">
                        <iframe id="map-canvas" class="map_part" width="100%" height="450" frameborder="0"
    ...
    <footer class="footer py-4 bg-primary">
        <div class="container-xxl">
            <div class="d-flex justify-content-between align-items-center">
                <p class="text-white">Copyright All Right Reserved 2024, Origami</p>
